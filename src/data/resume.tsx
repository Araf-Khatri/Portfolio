  ...
  experience: [
    {
      ...
      bullets: [
        "Architected and developed a full-stack serverless authentication system, owning end-to-end API development from backend to frontend using AWS Cognito, DynamoDB, API Gateway, and AWS Lambda, delivering secure and scalable user authentication (Python).",
        "Managing and maintaining the company's Content Hub, ensuring timely updates and seamless deployments to AWS S3.",
        "Built the company's marketing website landing page with a focus on responsive design and optimal user experience.",
      ],
      tech: [
        "NextJS",
        "TypeScript",
    ...
    },
    {
      ...
      bullets: [
        "Developed and managed 45% of the Admin Dashboard, including Admin Authentication and Role-Based Access Control (RBAC) UI, improving secure access management by 100%.",
        "Designed and implemented the Admin Session Booking Module UI, enabling streamlined session booking for admins.",
        "Collaborated with the backend team to integrate POS session payments in clinics, eliminating manual online payment processing and improving operational efficiency by 100%.",
